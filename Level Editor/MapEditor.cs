...
namespace Level_Editor
{
    public partial class MapEditor : Form
    {
        ...
        private void MapEditor_Load(object sender, EventArgs e)
        {
            ...
            cboCodeValues.Items.Add("NextLevel");
            cboCodeValues.Items.Add("Win");
            ...
            rearBackgroundToolStripMenuItem.Checked = true;
        }
        ...
        private void backgroundToolStripMenuItem_Click(object sender, EventArgs e)
        {
            game.DrawLayer = 0;
            rearBackgroundToolStripMenuItem.Checked = true;
            frontBackgroundToolStripMenuItem.Checked = false;
            interactiveToolStripMenuItem.Checked = false;
            foregroundToolStripMenuItem.Checked = false;
            TileMap.isToggleLocked = false;
        }

        private void closeBckgroundToolStripMenuItem_Click(object sender, EventArgs e)
        {
            game.DrawLayer = 1;
            rearBackgroundToolStripMenuItem.Checked = false;
            frontBackgroundToolStripMenuItem.Checked = true;
            interactiveToolStripMenuItem.Checked = false;
            foregroundToolStripMenuItem.Checked = false;
            TileMap.isToggleLocked = false;
        }
        ...
        private void loadMapToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                TileMap.LoadMap(new FileStream(Application.StartupPath + @"\MAP" + cboMapNumber.Items[cboMapNumber.SelectedIndex] +
                ".MAP",
                FileMode.Open));
            }
            catch
